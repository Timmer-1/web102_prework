...
// use filter or reduce to count the number of unfunded games with the ternary operator
const unfundedGamesCount = GAMES_JSON.filter(game => game.pledged < game.goal).length;

// create a string that explains the number of unfunded games using the ternary operator
const unfundedGamesString = unfundedGamesCount === 1 ? "is 1 game" : `are ${unfundedGamesCount} games`;

// create a new DOM element containing the template string and append it to the description container
const description = document.createElement("p");
description.innerHTML = `There ${unfundedGamesString} that have not yet reached their goal.`;
/************************************************************************************
